...
const Steps = () => {
    ...
    return (
        <ol className='rounded-md bg-white lg:flex lg:rounded-none lg:border-l lg:boorder-r lg:border-gray-200'>
            {
                STEPS.map((step, i) => {
                        ...
                        <div>
                            ...
                            <span className={cn(i !== 0 ? "lg:pl-9" : '',
                                ...
                                <span className='flex-shrink-0'>
                                    <img src={imgPath} className={cn("flex h-20 w-20 object-contain iotems-center justify-center",
                                        {
                                ...
                                <span className='ml-4 h-full mt-0.5 flex min-2-0 flex-col justify-center'>
